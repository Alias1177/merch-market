...
export let options = {
    scenarios: {
        constant_request_rate: {
            ...
            duration: '10s',          // длительность теста – 1 минута
            preAllocatedVUs: 1000,    // заранее выделяем 100 виртуальных пользователей
...
export default function () {
    // Здесь укажите URL вашего тестируемого эндпоинта.
